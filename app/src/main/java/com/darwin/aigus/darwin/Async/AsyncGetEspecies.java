...
public class AsyncGetEspecies extends AsyncTask<String, Void, List<Especie>> {
    ...
    public AsyncGetEspecies(DataBaseDarwin dataBaseDarwin, HelperAsync helperAsync) {
    ...
    protected List<Especie> doInBackground(String... strings) {
        return dataBaseDarwin.getEspecies(strings[0]);
    }
